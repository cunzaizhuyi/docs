...
当人们说edge，他们的意思的你的站点或者应用是同时部署在全球多个服务器上的，这样就能保整应用距离用户总是是近的。
...
让我们重新看看deno.com的速度，它部署在我们的边缘服务器网络里，Deno Deploy。

![deno.com](./img/edge/img_3.png)

除了新加坡，全世界范围的范围我们的第一个字节都可以在小于100毫秒内返回。
这是因为你并不需要去Virginia取站点数据，[每一个位置](https://deno.com/deploy/docs/regions)的用户都有自己对应的最近的边缘服务器。
你可以用VPN测试一下，比如：
